...
let darkTokens: TokenMap;
let highContrastTokens: TokenMap;
let rootTokens: TokenMap;
...
async function main(): Promise<void> {
  ...
  sharedTokens = { ...foundationTokens, ...componentTokens };
...
function buildCss(): string {
  return buildCssDocument(rootTokens, darkTokens, highContrastTokens, {
    fontFace: true,
    motionOverrides: true,
  });
}
